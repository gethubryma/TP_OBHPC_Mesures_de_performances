...
# Titre du graphique
set title "Histogramme comparant les version de dgemm-gcc"
...
plot datafile1 every ::1 using col:xtic(1) t "flag -Ofast" lc rgb "#32CD32"


# Dessiner l'histogramme2
set output 'comparaison_version_dgemm-O0.png'
plot datafile2 every ::1 using col:xtic(1) t "flag -O0" lc rgb "#32CD32"

# Dessiner l'histogramme3
set output 'comparaison_version_dgemm-O1.png'
plot datafile3 every ::1 using col:xtic(1) t "flag -O1" lc rgb "#32CD32"

# Dessiner l'histogramme4
set output 'comparaison_version_dgemm-O2.png
plot datafile4 every ::1 using col:xtic(1) t "flag -O2" lc rgb "#32CD32"

# Dessiner l'histogramme5
set output 'comparaison_version_dgemm-O3.png'
plot datafile5 every ::1 using col:xtic(1) t "flag -O3" lc rgb "#32CD32"