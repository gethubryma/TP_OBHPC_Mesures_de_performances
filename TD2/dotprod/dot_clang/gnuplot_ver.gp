...
# Titre du graphique
set title "histogramme de comparaison entre les version de dotprod-clang"
...
plot datafile1 every ::1 using 12:xtic(1) t "flag -O0" lc rgb "#59895C"


# Dessiner l'histogramme2
set output 'histog_compare_version_dotprod-O1.png'
plot datafile2 every ::1 using 12:xtic(1) t "flag -O1" lc rgb "#59895C"

# Dessiner l'histogramme3
set output 'histog_compare_version_dotprod-O2.png'
plot datafile3 every ::1 using 12:xtic(1) t "flag -O2" lc rgb "#59895C"

# Dessiner l'histogramme4
set output 'histog_compare_version_dotprod-O3.png'
plot datafile4 every ::1 using 12:xtic(1) t "flag -O3" lc rgb "#59895C"

# Dessiner l'histogramme5
set key top center
set output 'histog_compare_version_dotprod-Ofast.png'
plot datafile5 every ::1 using 12:xtic(1) t "flag -Ofast" lc rgb "#59895C"

# Dessiner l'histogramme5
set output 'histog_compare_version_dotprod-Os.png'
plot datafile6 every ::1 using 12:xtic(1) t "flag -Os" lc rgb "#59895C"